...
<template>
  ...
  <div class="container">
    ...
    <form @submit.prevent="cadastraTarefa">
      <div class="row">
        <div class="col">
          <input :value="estado.tarefaTemp" @change="evento => estado.tarefaTemp = evento.target.value" required type="text" class="form-control" placeholder="Digiete a sua nova tarefa">
        </div>
        <div class="col-md-2">
